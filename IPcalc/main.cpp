...
VOID PrintInfo(HWND hwnd)
{
	...
	sprintf(sz_NetworkIP_buffer, "Адресс сети: %s", IPaddressToString(dwIPaddress & dwIPmask, sz_buffer));
	sprintf(sz_BroadcastIP_buffer, "широковещательный Адресс: %s", IPaddressToString(dwIPaddress | ~dwIPmask, sz_buffer));
