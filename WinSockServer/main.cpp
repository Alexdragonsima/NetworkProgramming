...
void main()
{
	...
	//3) создаем моккет который будет прослушивать сервер
	SOCKET ListenSocket =
	...
	//4) создаем сокет с сетевой картой которую он будет прослушивать
	...
	//6) зацткливаем сокет на получение соединений от клиентов
